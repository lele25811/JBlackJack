...
public class MazzoDaGioco {
	...
	/**
	 * Il Metodo unisciMazzi serve al costruttore per costruire la mazzoGioco.
	 */
	...
	/**
	 * Metodo che ritorna la lunghezza del mazzo di carte.
	 * @return numero di carte nel mazzo di gioco
	 */
	 ...
	 * @return la prossima carta nel mazzo
	 */
	...
	/**
	 * Il Metodo scartaCarte mette nel mazzoScarti le carte che erano in gioco e
	 * pulisce l'ArrayList di carteInGioco per la prossima mano.
	 */
	...
	/**
	 * Metodo che ritorna il numero di carte nel mazzo degli scarti.
	 * @return numero di carte nel mazzo degli scarti
	 */
